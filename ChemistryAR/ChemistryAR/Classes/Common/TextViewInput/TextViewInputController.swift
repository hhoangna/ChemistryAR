...
extension UIAlertController {
    ...
    func showTextViewInput(placeholder:String,
        ...
        let doneAction = UIAlertAction(title: "Submit".localized, style: .default) { (ok) in
        ...
        doneAction.isEnabled = !isEmpty(oldText)
...
final class TextViewInputViewController: UIViewController, TextViewInputDelegate {
    ...
    func setupButtonClear() {
        ...
        let button = UIButton()
        button.frame = frame
        button.setImage(#imageLiteral(resourceName: "ic_removeText"), for: .normal)
