...
class PeriodicTableVC: BaseVC {
    ...
    func setupNavigationBar() {
        let rightItem = UIBarButtonItem.searchButton(target: self, action: #selector(onNavigationClickRightButton(_:)))
        App().mainVC?.barController?.navigationItem.rightBarButtonItems = [rightItem]
    }
    ...
    @objc override func onNavigationClickRightButton(_ sender: UIBarButtonItem) {
        let vc: ElementListVC = .load(SB: .Periodic)
