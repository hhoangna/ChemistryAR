...
class ScannedObject: SCNNode {
    ...
    func fitOverPointCloud(_ pointCloud: ARPointCloud) {
        ...
        let hitTestResults = sceneView.hitTest(ScanObjectVC.instance!.screenCenter, types: .featurePoint)
    ...
    private func updateOrCreateGhostBoundingBox() {
        // Perform a hit test against the feature point cloud.
        guard let result = sceneView.smartHitTest(ScanObjectVC.instance!.screenCenter) else {
