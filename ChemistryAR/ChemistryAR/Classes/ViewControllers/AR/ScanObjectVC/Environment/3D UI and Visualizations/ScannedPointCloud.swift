...
class ScannedPointCloud: SCNNode, PointCloud {
    ...
    func updateOnEveryFrame() {
        ...
        self.pointNode.geometry = createVisualization(for: renderedPoints, color: AppColor.yellowColor, size: 12)
        self.preliminaryPointsNode.geometry = createVisualization(for: renderedPreliminaryPoints, color: AppColor.lightYellowColor, size: 12)
    }
