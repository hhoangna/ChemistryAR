...
extension ScanObjectVC {
    ...
    var state: State {
        ...
        set {
            ...
            NotificationCenter.default.post(name: ScanObjectVC.appStateChangedNotification,
                                            object: self,
                                            userInfo: [ScanObjectVC.appStateUserInfoKey: self.state])
        }
    }
